...
enum cracen_kd_state {
	...
	/* HMAC CTR states: */
	CRACEN_KD_STATE_HMAC_CTR_INIT = 0x80,
	CRACEN_KD_STATE_HMAC_CTR_KEY_LOADED,
	CRACEN_KD_STATE_HMAC_CTR_INPUT_LABEL,
	CRACEN_KD_STATE_HMAC_CTR_INPUT_CONTEXT,
	CRACEN_KD_STATE_HMAC_CTR_OUTPUT,

	/* TLS12 PRF states: */
	CRACEN_KD_STATE_TLS12_PRF_INIT = 0x100,
	CRACEN_KD_STATE_TLS12_PRF_OUTPUT,

	/* TLS12 PSK TO MS states: */
	CRACEN_KD_STATE_TLS12_PSK_TO_MS_INIT = 0x200,
	CRACEN_KD_STATE_TLS12_PSK_TO_MS_OUTPUT,

	/* TLS12 EC J-PAKE to PMS state: */
	CRACEN_KD_STATE_TLS12_ECJPAKE_TO_PMS_INIT = 0x400,
