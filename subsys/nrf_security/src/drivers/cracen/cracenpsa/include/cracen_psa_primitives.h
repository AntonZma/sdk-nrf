...
// TODO: Update the following context for GCM
struct cracen_sw_gcm_context_s {
	...
	// bool gcm_initialized;
	// uint8_t j0[SX_BLKCIPHER_AES_BLK_SZ];
...
struct cracen_aead_operation {
	...
	bool ad_finished;
	struct sxaead ctx;
#if defined(CONFIG_PSA_NEED_CRACEN_CTR_SIZE_WORKAROUNDS) // TODO: remove "CONFIG_" prefix
